...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      ...
      GitHub: {
        name: "GitHub",
        url: "https://github.com/bhuwanmahato",
        icon: Icons.github,
      ...
      // Youtube: {
      //   name: "Instagram",
      //   url: "https://www.instagram.com/i_am_bhu1/",
      //   icon: Icons.youtube,
      //   navbar: true,
      // },
      email: {
  ...
  work: [
    {
      ...
      description:
        "Part of the core development team of Hermes Project of BP Shipping and Vetting with the following responsibilities: Responsible for software maintenance like implementing new features, bug reporting and fixing, and supporting system testing. Responsible for managing and maintaining data using SQL. Presenting all the new features and improvements to all the consumers every sprint. Liaising with other teams and consumers, analyzing their needs and concerns, and successfully addressing them.",
    },
    {
  ...
  projects: [
    ...
    {
      title: "Themefy",
      href: "/projects/themefy",
      dates: "Jun 2024 - Jul 2024",
      active: true,
      description:
        "Bringing creative coding to everyday browsing - Browser Extension | (10$ MRR) | 1000+ active users",
      technologies: [
        "Figma",
        "Illustrator",
        "Spline",
